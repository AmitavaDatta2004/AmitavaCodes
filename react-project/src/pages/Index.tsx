...
const Index = () => {
  ...
  // Only show splash when directly accessing the home page via URL or reload
  const showSplash = !location.state || !location.state.navigated;
  ...
  return (
    <ThemeProvider>
      {loading ? (
        <SplashScreen onComplete={handleSplashComplete} forceSplash={showSplash} />
      ) : (
